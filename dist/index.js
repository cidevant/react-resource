...
var _each = __webpack_require__(100);

var _each2 = _interopRequireDefault(_each);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function ReactResource(url) {
  ...
  function ResourceModel() {
    ...
    if ((0, _isObject2.default)(data)) (0, _each2.default)(data, function (val, key) {
  ...
  // Build actions
  var actionsBuilder = new ActionsBuilder(url, mappings, customActions);
  actionsBuilder.classMethods(ResourceModel);
  actionsBuilder.instanceMethods(ResourceModel);
